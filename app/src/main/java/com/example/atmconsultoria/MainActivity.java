...
public class MainActivity extends AppCompatActivity {
    ...
    public void enviarEmail(){
        ...
        String imagem = "https://assets-cdn.kangaroo.com.br/images/maldivas/radisson-blu-resort-maldives-vista-aerea.jpg";

        Intent intent = new Intent(Intent.ACTION_SEND);
        intent.putExtra( Intent.EXTRA_EMAIL, new String[]{"atendimento@gmail.com"} );
