...
public class SobreFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String descrição = "A ATM Consultoria tem como missão apoiar organizações que desejam alcançar o sucesso atraves da " +
                "excelencia em gestão e da busca pela qualidade";
        ...
        return new AboutPage(getActivity())
                ...
                .addFacebook("SilasBorges", "Facebook")
                .addInstagram("SilasBorges", "Instagram")
